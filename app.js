...
//cssurl = 'https://rawgit.com/Koeroesi86/camTest/master/style.css';
...
var injectClipBoard = function() {
    console.log('injecting clipboard');
    var _script = $("<script type='text/javascript' src='http://datapoint.hu/6cams/clipboard.min.js'></script>");
    $('body').append(_script);
};
...
var injectCSS = function() {
    var cssurl = 'http://datapoint.hu/6cams/sixcams.css?v=3a1b';
...
var injectControls = function(){
    ...
    // next / prev btns
    $('body').append(markup);
    markup.find('ul.ctls').append('<li class="next">next page</li><li class="prev">prev page</li><li class="ctlstoggle">Toggle ctls</li>"');
    ...
    previewBoxes.each(function (index, elem){
        ...
        streamContainer.append('<div class="mask"></div>');
        ...
        // copy to clipboard
        var copyToClipboardText = 'http://cams3peter.dnxlive.com/gateway/test/test_cams.php?nickname=' + nick + '&ip=' + getIp();
        mask.append('<div class="copyToClipboard" data-clipboard-text="' + copyToClipboardText + '"></div>');
...
var initScript = function() {
    ...
    $('.ctlstoggle').bind('click', function() {
        toggleCtls();
    });
